    ...
    <div class="flex flex-col h-full select-none">
        ...
        <div class="px-4 py-3.5 border-t border-white/[0.08] bg-slate-950/40 shrink-0">
            <div class="flex items-center gap-3">
                ...
                <!-- Settings Button -->
                <button
                    class="p-1.5 rounded-lg text-slate-400 hover:text-indigo-300 hover:bg-white/10 transition-colors me-1"
...
const emit = defineEmits(['navigate', 'logout', 'open-settings'])
    ...
    list.push(
        ...
        },
        {
            ...
            items: [
                ...
                ...(auth.isOwner ? [{ to: '/accounts', label: 'nav.wallets', icon: 'wallets' }] : []),
