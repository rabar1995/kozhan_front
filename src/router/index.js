...
const routes = [
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'accounts', name: 'accounts', component: () => import('../views/AccountList.vue'), meta: { title: 'nav.wallets' } },
            ...
            { path: 'exchange-rates', name: 'exchange-rates', component: () => import('../views/ExchangeRates.vue'), meta: { title: 'nav.exchangeRates', role: 'owner' } },
